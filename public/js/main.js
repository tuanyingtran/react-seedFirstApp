                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                'button',
                                { className: 'btn btn-primary glyphicon-plus-sign' },
                                ' Add'
                            )
                        )
                    )
...
ReactDom.render(React.createElement(ListManager, { title: 'To Do', headingColor: 'black' }), document.getElementById('todo'));
ReactDom.render(React.createElement(ListManager, { title: 'Camping Gear', headingColor: 'red' }), document.getElementById('campingGear'));
